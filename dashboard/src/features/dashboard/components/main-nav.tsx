...
export function MainNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 flex h-[72px] w-full justify-center border-b border-gray-200 bg-white px-8 py-4 max-md:hidden dark:border-gray-800 dark:bg-gray-950">
